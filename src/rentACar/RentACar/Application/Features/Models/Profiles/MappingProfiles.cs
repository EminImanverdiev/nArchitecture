...
public class MappingProfiles:Profile
{
    ...
    {
        ///bezen ele olurki BrandName bu qayda sekilinde yazilmiyanda mapliya bilmir onun ucun by formda eliye bilirik
        CreateMap<Model, GetListModelListItemDto>()
              ...
              .ReverseMap();
        CreateMap<Paginate<Model>,GetListResponse<GetListBrandListItemDto>>().ReverseMap();
